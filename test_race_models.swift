...
// Test all cloud models with same tiny prompt
for model in ["kimi-k2.5:cloud", "glm-5.1:cloud", "qwen3.5:cloud", "qwen3-coder-next:cloud"] {
    runTest(label: model, model: model, system: systemPrompt,
            prompt: "Fix grammar: Sharper product judgment captured in working note.")
}

// Also test local tiny model
runTest(label: "qwen3:0.6b (LOCAL)", model: "qwen3:0.6b", system: systemPrompt,
        prompt: "Fix grammar: Sharper product judgment captured in working note.")
